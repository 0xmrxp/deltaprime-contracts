...
/**
 * RedStone node migration (branch: feat/migrate-rs-nodes) — Avalanche redeploy.
 *
 ...
 *   - SolvencyFacetProdAvalanche dropped its per-chain getDataServiceId /
 ...
 * deployments/avalanche/rs-node-migration.verify-manifest.json, and verification
 * can be re-run any time (idempotently) with:
 *   npx hardhat run tools/scripts/verify-deployments.js --network avalanche
 */

// SolvencyFacetProdAvalanche's bytecode carries an unresolved GmxBenchmarkMath
...
// be linked into SolvencyFacetProdAvalanche. Its source is unchanged by this
...
module.exports = async ({ getNamedAccounts, deployments }) => {
    ...
    console.log("== Avalanche RedStone node migration redeploy ==");
    ...
    console.log("\n== Deploy summary (Avalanche RedStone node migration) ==");
    ...
    console.log("     redstone-avalanche-prod to redstone-primary-prod together with step 1.");
};

module.exports.tags = ["avalanche-rs-node-migration"];
