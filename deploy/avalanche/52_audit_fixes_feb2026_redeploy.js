 ...
 *   - The deployed `TraderJoeV2AvalancheFacet` artifact on this branch does not expose
 *     the selector either.
 ...
 * for the Avalanche deployment, then writes a verify manifest and runs
 * block-explorer (Snowtrace/Routescan) + Tenderly verification for each one.
 *
 ...
 *     - AssetsOperationsAvalancheFacet      (M-06, M-12)
 *     - GmxV2FacetAvalanche                 (M-05, inherits GmxV2FeesHelper M-12/M-17)
 *     - GmxV2PlusFacetAvalanche             (M-05 follow-up, inherits GmxV2FeesHelper)
 *     - GmxV2CallbacksFacetAvalanche        (inherits GmxV2FeesHelper - M-12/M-17)
 *     - SolvencyFacetProdAvalanche          (DPSC-340)
 ...
 *
 * Verification is decoupled: the deploy writes deployments/avalanche/
...
//   - AssetsOperationsAvalancheFacet: calls GmxBenchmarkMath.premiumScaledUnderlying.
//   - SolvencyFacetProdAvalanche:     calls GmxBenchmarkMath.deductibleFeeInGmTokens.
//   - SmartLoanViewFacet:             reaches the library through
//                                     GmxV2FeesHelper._getDeductibleFeesInGmTokens.
// Other GmxV2FeesHelper inheritors (GmxV2*Facet) do NOT appear here — they never reach
// that internal function, so solc dead-code-eliminates it and emits no placeholder.
...
const TARGETS = [
    ...
    // { name: "GmxV2CallbacksFacetAvalanche",   embedDir: "./contracts/facets/avalanche", contract: "contracts/facets/avalanche/GmxV2CallbacksFacetAvalanche.sol:GmxV2CallbacksFacetAvalanche" },
    // { name: "SolvencyFacetProdAvalanche",     embedDir: "./contracts/facets/avalanche", contract: "contracts/facets/avalanche/SolvencyFacetProdAvalanche.sol:SolvencyFacetProdAvalanche" },
...
module.exports = async ({ getNamedAccounts, deployments }) => {
    ...
    console.log("== Avalanche audit-fixes-feb2026 redeploy ==");
    ...
    // Block-explorer (Snowtrace/Routescan) verification. verifyDeployment submits
    // the exact saved solc input as a minimal closure and reads any library link
...
module.exports.tags = ["avalanche-audit-fixes-feb2026"];
